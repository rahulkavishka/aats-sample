...
export default function Nexora() {
    ...
    return (
        <div className="min-h-screen p-6 space-y-8 pb-20 animate-in fade-in duration-500 bg-slate-50/50 dark:bg-[#0f0718] dark:bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] dark:from-[#2d1b4e]/30 dark:via-[#0f0718] dark:to-[#0f0718]">
            ...
            {/* Header */}
            <div>
                <h1 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent pb-1 bg-gradient-to-br from-[#524096] via-[#5f2a84] to-[#01cbae] dark:from-[#d8b4fe] dark:via-[#01cbae] dark:to-[#01efac]">
                    Nexora Dashboard
                </h1>
            ...
            <Card className="shadow-md overflow-hidden border-0 ring-1 ring-slate-200 dark:ring-[#2d1b4e] dark:bg-[#1a103c]/40 backdrop-blur-sm">
                <div className="h-1.5 w-full bg-gradient-to-r from-[#01efac] to-[#01cbae]" />
                <CardHeader className="bg-slate-50/50 dark:bg-[#2d1b4e]/20">
                    <CardTitle className="text-xl flex items-center gap-2 text-[#5f2a84] dark:text-[#d8b4fe]">
                        <div className="p-1.5 rounded-full bg-[#5f2a84]/10 dark:bg-[#d8b4fe]/10">
                            <Plus className="h-5 w-5 text-[#5f2a84] dark:text-[#d8b4fe]" />
                        </div>
                ...
                <CardContent className="p-6 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Request ID</Label>
                            <Input
                                value="NEX-AUTO-005"
                                disabled
                        ...
                        {/* Date */}
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Date</Label>
                            <Popover>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        <CalendarIcon className="mr-2 h-4 w-4 text-[#01cbae]" />
                        ...
                        {/* Client Name */}
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Client Name</Label>
                        ...
                        {/* Company Name */}
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Company Name</Label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Service Dropdown */}
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Service Required</Label>
                            <Select>
                        ...
                        {/* Source Docs */}
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Source Documents</Label>
                            <div className="flex items-center gap-3">
                                ...
                                <div
                                    ...
                                    className="flex-1 border-2 border-dashed rounded-md h-10 flex items-center px-3 gap-2 cursor-pointer hover:bg-slate-50 dark:hover:bg-[#2d1b4e]/30 transition-colors group dark:bg-[#130b29] dark:border-[#2d1b4e] border-[#2082a6]"
                                >
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {sourceDocs.map((doc, i) => (
                                        <Badge
                                            key={i}
                                            variant="secondary"
                                            className="gap-1 pl-2 pr-1 py-1 border border-[#01cbae]/30 dark:border-[#01cbae]/50 bg-[#01efac]/10 text-[#01cbae]"
                                        >
                    ...
                    {/* Notes */}
                    <div className="space-y-2">
                        <Label className="text-[#2082a6] dark:text-[#01cbae]">Notes</Label>
                        <Textarea
                ...
                <CardFooter className="bg-slate-50/50 dark:bg-[#2d1b4e]/20 p-4 flex justify-end gap-3 border-t dark:border-[#2d1b4e]">
                    ...
                    <Button
                        className="text-white shadow-lg hover:shadow-xl transition-all border-0 bg-gradient-to-br from-[#01efac] to-[#01cbae]"
                    >
                        Submit Request
                    </Button>
                </CardFooter>
            ...
            <div className="space-y-4">
                ...
                <Card className="shadow-sm border-0 ring-1 ring-slate-200 dark:ring-[#2d1b4e] dark:bg-[#1a103c]/40 backdrop-blur-sm">
                    <CardContent className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        <div className="space-y-2 md:col-span-3">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Search Records</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[#2082a6] dark:text-[#01cbae]">Filter Service</Label>
                            <Select>
                                <SelectTrigger className="focus:ring-[#01cbae] dark:bg-[#130b29] dark:border-[#2d1b4e] dark:text-slate-200">
                ...
                <Card className="overflow-hidden border-0 shadow-md ring-1 ring-slate-200 dark:ring-[#2d1b4e] dark:bg-[#1a103c]/40 backdrop-blur-sm">
                    <div className="h-1 w-full bg-gradient-to-r from-[#2082a6] via-[#524096] to-[#5f2a84]" />
                    <Table>
                        <TableHeader className="bg-slate-50 dark:bg-[#2d1b4e]/20">
                            <TableRow>
                                <TableHead className="w-[50px] pl-6"><Checkbox /></TableHead>
                                <TableHead className="text-[#2082a6] dark:text-[#01cbae]">ID</TableHead>
                                <TableHead className="text-[#2082a6] dark:text-[#01cbae]">Company Name</TableHead>
                                <TableHead className="text-[#2082a6] dark:text-[#01cbae]">Service</TableHead>
                                <TableHead className="text-[#2082a6] dark:text-[#01cbae]">Phone</TableHead>
            ...
            <div className="space-y-4 pt-8 border-t">
                <h3 className="text-lg font-semibold text-[#524096] dark:text-[#d8b4fe]">Contact Us</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* Website */}
                    <Card className="hover:shadow-lg transition-all cursor-pointer group border-0 ring-1 ring-slate-200 dark:ring-slate-800 overflow-hidden">
                        <div className="h-1 w-full bg-gradient-to-r from-[#01efac] to-[#01cbae]" />
                        <CardContent className="p-6 flex items-center gap-4">
            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                <SheetContent className="sm:max-w-md border-l-4 dark:bg-[#1a103c] border-l-[#01cbae] dark:border-l-[#01cbae]">
                    <SheetHeader>
                        <SheetTitle className="text-xl dark:text-[#d8b4fe] text-[#524096]">Request Details</SheetTitle>
