...
import type { WHTStatus } from './WHTPage';
...
interface WHTFormProps {
    onSubmit: (data: WHTFormData) => void;
}

const WHTForm: React.FC<WHTFormProps> = ({ onSubmit }) => {
    const { register, handleSubmit, setValue, watch, reset, formState: { errors } } = useForm<WHTFormData>({
        defaultValues: {
            periodUnit: 'Months',
            status: 'Pending',
        },
    ...
    const onFormSubmit = (data: WHTFormData) => {
        onSubmit(data);
        reset();
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-4 space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="clientName"
                                        placeholder="e.g. Gamma Services"
                        ...
                        <div className="lg:col-span-4 space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="whtNo">WHT Reg No.</Label>
                                    <Input
                                        id="whtNo"
                                        placeholder="e.g. WHT-999000"
                                        {...register('whtNo', { required: true })}
                                    />
                                    {errors.whtNo && <span className="text-xs text-red-500">Required</span>}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            <RadioGroup
                                ...
                                onValueChange={(val: WHTStatus) => setValue('status', val)}
