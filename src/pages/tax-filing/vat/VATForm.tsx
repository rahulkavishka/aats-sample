...
import type { VATStatus } from './VATPage';
...
const VATForm: React.FC<VATFormProps> = ({ onSubmit }) => {
    const { register, handleSubmit, setValue, watch, reset, formState: { errors } } = useForm<VATFormData>({
        defaultValues: {
            periodUnit: 'Months',
            status: 'Pending',
        },
    ...
    const onFormSubmit = (data: VATFormData) => {
        onSubmit(data);
        reset();
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-4 space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.vatNo && <span className="text-xs text-red-500">Required</span>}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            <RadioGroup
                                ...
                                onValueChange={(val: VATStatus) => setValue('status', val)}
