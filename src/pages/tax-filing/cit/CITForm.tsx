...
import type { CITStatus } from './CITPage';
...
interface CITFormProps {
    onSubmit: (data: CITFormData) => void;
}

const CITForm: React.FC<CITFormProps> = ({ onSubmit }) => {
    const { register, handleSubmit, setValue, watch, reset, formState: { errors } } = useForm<CITFormData>({
        defaultValues: {
            periodUnit: 'Months',
            status: 'Pending',
        },
    ...
    const onFormSubmit = (data: CITFormData) => {
        onSubmit(data);
        reset();
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-4 space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="dinNo">Director ID (DIN)</Label>
                                    <Input
                                        id="dinNo"
                                        placeholder="e.g. DIN-123456"
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            <RadioGroup
                                ...
                                onValueChange={(val: CITStatus) => setValue('status', val)}
